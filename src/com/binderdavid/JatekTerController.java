...
public class JatekTerController {
    ...
    private  static String[] palya(Karakter k1, Karakter k2){
    ...
    private static  void palyaMegjelenito(String[]palya,Karakter k1,Karakter k2 ){
        String palyaKiiras="";
    ...
    private static  void palyaMegjelenitoHarc(String[]palya,Karakter k1,Karakter k2 ){
        String palyaKiiras="";
        for (int i = 0; i < palya.length; i++) {
            palyaKiiras+=palya[i];
